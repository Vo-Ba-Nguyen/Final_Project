                ...
                <div class="card-body">
                    ...
                    <div class="form-group mt-1">
                        ...
                        <div class="input-group">
                            <input v-model="addProduct.hinh_anh" id="hinh_anh" class="form-control" type="text" name="filepath">
                            <span class="input-group-prepend">
                                <a id="lfm" data-input="hinh_anh" data-preview="holder" class="btn btn-primary">
                                    <i class="fa fa-picture-o"></i> Choose
                                </a>
                            </span>
                            {{-- <input name="hinh_anh" id="hinh_anh" data-input="thumbnail" type="button" data-preview="holder" value="Tải Lên"> --}}
                            {{-- <input id="thumbnail" class="form-control" v-model="addProduct.hinh_anh" type="text" name="filepath"> --}}
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="position-relative">
                            <input v-model="input_search" v-on:keyup="searchSanPham()" type="text" class="form-control ps-5" placeholder="Tên sản phẩm..."><span class="position-absolute top-50 product-show translate-middle-y"><i class="bx bx-search"></i></span>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <template v-for="(value, key) in list_san_pham">
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <button class="btn btn-danger" data-bs-toggle="modal" v-on:click="delete_SanPham = value" data-bs-target="#deleteProduct" style="width: 120px">Delete <i class="bx bx-trash-alt me-0"></i></button>
                                            </th>
                                        </tr>
                                    </template>
                                </tbody>
