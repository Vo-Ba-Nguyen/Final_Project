            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="position-relative">
                        <input v-model="input_search" v-on:keyup="searchDanhMuc()" type="text" class="form-control ps-5" placeholder="Tên danh mục..."><span class="position-absolute top-50 product-show translate-middle-y"><i class="bx bx-search"></i></span>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            <template v-for="(value , key) in list_danh_muc">
                                <tr>
                                    ...
                                    <th>
                                        <button class="btn btn-success" data-bs-toggle="modal" v-on:click="update_danh_muc = value" data-bs-target="#updateModal">Update <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                        <button class="btn btn-danger" data-bs-toggle="modal" v-on:click="delete_danh_muc = value" data-bs-target="#deleteModal">Delete<i class="bx bx-trash-alt me-0"></i></button>
                                    </th>
                                </tr>
                            </template>
                        </tbody>
                    ...
                    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="UpdateCategoryModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="button" v-on:click='deleteDanhMuc()' class="btn btn-primary" data-bs-dismiss="modal">Delete<i class="bx bx-trash-alt me-0"></i></button>
                            </div>
                            </div>
                        </div>
                    </div>
